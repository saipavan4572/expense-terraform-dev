...
# backend accepting traffic from ansible - For understanding purpose only, not mandatory
...
# frontend accepting traffic from ansible - For understanding purpose only, not mandatory
...
# ansible accepting traffic from public - For understanding purpose only, not mandatory
